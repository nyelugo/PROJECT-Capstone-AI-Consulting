...
A2 = {
    ...
    "anomaly_candidates_per_batch": (190, "assumption",
        "candidates in ONE capped monthly review batch. The 190 was raised by the detector on "
        "the 200-account, 90-day synthetic fixture, so it sizes a bounded analyst queue rather "
        "than the client's transaction book. detect() applies no cap, so at the same 1.71% "
        "rate the full book would raise ~104,500 a month. UC-2 is costed as a reviewed "
