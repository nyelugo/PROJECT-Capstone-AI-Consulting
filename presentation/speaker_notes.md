...
On the right is a different case — 1 of the 4 stopped by the quote check. LangSmith records every evaluation outcome. Of 60 cases, 52 produced a proposal; 4 stopped for low confidence and 4 because the quoted evidence was absent from the complaint.
